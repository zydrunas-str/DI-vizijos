...
window.EXHIBITION = {
  ...
  dates: "2025 m. balandžio 15 d. – 2026 m. balandžio 24 d.",
...
window.AUTHORS = [
  {
    ...
    gallery: [
      { src: "assets/works/aida/01.jpg", title: "Anti-utopia", format: "A2" },
      { src: "assets/works/aida/02.jpg", title: "Šaknis", format: "A2" },
      { src: "assets/works/aida/03.jpg", title: "Viltis po sparnu", format: "A2" },
      { src: "assets/works/aida/04.jpg", title: "Žuvies rinkėja", format: "A2" },
      { src: "assets/works/aida/05.jpg", title: "Paukščių globėjas", format: "A2" },
      { src: "assets/works/aida/06.jpg", title: "Rara avis", format: "A2" },
      { src: "assets/works/aida/07.jpg", title: "Camera", format: "A2" },
      { src: "assets/works/aida/08.jpg", title: "Bunnita", format: "A2" },
      { src: "assets/works/aida/kubas1-01.jpg", title: "diptikas Judėjimo mirażai / siena 1", format: "50×50 cm" },
      { src: "assets/works/aida/kubas1-02.jpg", title: "diptikas Judėjimo mirażai / siena 2", format: "50×50 cm" },
      { src: "assets/works/aida/kubas1-03.jpg", title: "diptikas Judėjimo mirażai / siena 3", format: "50×50 cm" },
      { src: "assets/works/aida/kubas1-04.jpg", title: "diptikas Judėjimo mirażai / siena 4", format: "50×50 cm" },
      { src: "assets/works/aida/kubas1-05.jpg", title: "diptikas Judėjimo mirażai / siena 5", format: "50×50 cm" },
      { src: "assets/works/aida/kubas1-06.jpg", title: "diptikas Judėjimo mirażai / siena 6", format: "50×50 cm" },
      { src: "assets/works/aida/kubas2-01.jpg", title: "diptikas Judėjimo mirażai / siena 1", format: "50×50 cm" },
      { src: "assets/works/aida/kubas2-02.jpg", title: "diptikas Judėjimo mirażai / siena 2", format: "50×50 cm" },
      { src: "assets/works/aida/kubas2-03.jpg", title: "diptikas Judėjimo mirażai / siena 3", format: "50×50 cm" },
      { src: "assets/works/aida/kubas2-04.jpg", title: "diptikas Judėjimo mirażai / siena 4", format: "50×50 cm" },
      { src: "assets/works/aida/kubas2-05.jpg", title: "diptikas Judėjimo mirażai / siena 5", format: "50×50 cm" },
      { src: "assets/works/aida/kubas2-06.jpg", title: "diptikas Judėjimo mirażai / siena 6", format: "50×50 cm" }
    ]
  },
  {
    id: "adas",
  ...
  },
  {
    ...
    gallery: [
      { src: "assets/works/gerda/01.jpg", title: "Dykumos", format: "A2" },
      { src: "assets/works/gerda/02.jpg", title: "Klajonės", format: "A2" },
      { src: "assets/works/gerda/03.jpg", title: "Veneros gimimo interpretacija", format: "A2" },
      { src: "assets/works/gerda/04.jpg", title: "Virsmas (triptikas)", format: "A2" }
    ]
  },
  {
    id: "zydrunas",
    ...
    works: ["Sapnų paukščiai I–IV", "Laivų stebėtojas I–II", "Pirmadienio keliautojas I–II", "Norai I–III", "Beprasmybė", "Mandagumas", "Naujas pasaulis"],
    annotation: "assets/annotations/anno-zydrunas.jpg",
    portrait: "assets/portraits/zydrunas.jpg",
    gallery: [
      { src: "assets/works/zydrunas/01.jpg", title: "Sapnų paukščiai I", format: "A2" },
      { src: "assets/works/zydrunas/02.jpg", title: "Laivų stebėtojas I", format: "A2" },
      { src: "assets/works/zydrunas/03.jpg", title: "Pirmadienio keliautojas I", format: "A2" },
      { src: "assets/works/zydrunas/04.jpg", title: "Beprasmybė", format: "A2" },
      { src: "assets/works/zydrunas/05.jpg", title: "Laivų stebėtojas II", format: "A2" },
      { src: "assets/works/zydrunas/06.jpg", title: "Norai I", format: "A2" },
      { src: "assets/works/zydrunas/07.jpg", title: "Norai II", format: "A2" },
      { src: "assets/works/zydrunas/08.jpg", title: "Sapnų paukščiai II", format: "A2" },
      { src: "assets/works/zydrunas/09.jpg", title: "Norai III", format: "A2" },
      { src: "assets/works/zydrunas/10.jpg", title: "Sapnų paukščiai III", format: "A2" },
      { src: "assets/works/zydrunas/11.jpg", title: "Sapnų paukščiai IV", format: "A2" },
      { src: "assets/works/zydrunas/12.jpg", title: "Mandagumas", format: "A2" },
      { src: "assets/works/zydrunas/13.jpg", title: "Pirmadienio keliautojas II", format: "A2" },
      { src: "assets/works/zydrunas/14.jpg", title: "Naujas pasaulis", format: "A2" }
    ]
  }
];
