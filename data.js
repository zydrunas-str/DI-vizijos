...
window.AUTHORS = [
  ...
  },
  {
    ...
    works: ["Nu, literaliai — frazeologizmų serija A2"],
    annotation: "assets/annotations/anno-adas.jpg",
    portrait: "assets/portraits/adas.jpg",
    gallery: [
      { src: "assets/works/adas/01.jpg", title: "Nu, literaliai I", format: "A2" },
      { src: "assets/works/adas/02.jpg", title: "Nu, literaliai II", format: "A2" },
      { src: "assets/works/adas/03.jpg", title: "Nu, literaliai III", format: "A2" },
      { src: "assets/works/adas/04.jpg", title: "Nu, literaliai IV", format: "A2" },
      { src: "assets/works/adas/05.jpg", title: "Nu, literaliai V", format: "A2" },
      { src: "assets/works/adas/06.jpg", title: "Nu, literaliai VI", format: "A2" },
      { src: "assets/works/adas/07.jpg", title: "Nu, literaliai VII", format: "A2" },
      { src: "assets/works/adas/08.jpg", title: "Nu, literaliai VIII", format: "A2" },
      { src: "assets/works/adas/09.jpg", title: "Nu, literaliai IX", format: "A2" },
      { src: "assets/works/adas/10.jpg", title: "Nu, literaliai X", format: "A2" }
    ]
  },
  {
    id: "joana",
